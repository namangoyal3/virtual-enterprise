...
engineer = Agent(
    ...
    backstory="You implement what's in the PRD — clean, tested, deployable code.",
    llm=llm,
    verbose=True,
)
...
def execute_company_mission(directive: str, ga4_property_id: Optional[str] = None):
    ...
    task_prd = Task(
        description="PM: Write a Markdown PRD for a feature/optimization based on the Analyst's findings.",
...
if __name__ == "__main__":
    ga4_id = "529697573"
    directive = "Analyze why user conversion for Pro upgrade is lower in the Learn vertical and propose a data-driven UX improvement."
    print(f"\n🚀 ENTERPRISE MISSION: {directive}")
    print(execute_company_mission(directive, ga4_id))
